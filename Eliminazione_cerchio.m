...
%   Input: sezione_mesh � la sezione orizzontale di interesse 
%          coordinate_centro sono le coordinate ESATTE del centro del
%          cerchio che si desidera approssimare
%          R � il raggio del cerchio espresso in unit� di misura "Voxel" -
%          intero maggiore di 0
%          ID_trabecola � il numero che identifica univocamente la
%          trabecola in analisi
%   Output: sezione_mesh_inattivata � la sezione orizzontale di interesse
