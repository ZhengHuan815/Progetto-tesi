...
for i=1:R_max 
    ...
    while dz<=dy %scorre i punti della circonferenza del primo ottante superiore
            ...
            %� sufficiente che un solo punto della circonferenza appartenga alla trabecola 
    ...
    %se logical � rimasto uno significa che il while ha scorso tutta la
    %circonferenza senza incontrare punti appartenenti alla trabecola.
    %di conseguenza il raggio � quello cercato e si esce dal for,
